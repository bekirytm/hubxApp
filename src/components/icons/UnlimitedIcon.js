...
function SvgUnlimitedIcon(props) {
  return (
    <Svg
      width={36}
      height={36}
      ...
      <Rect
        ...
        fillOpacity={0.24}
      />
      <G clipPath="url(#unlimitedIcon_svg__clip0_1_1136)" fill="#fff">
      ...
      <Defs>
        <ClipPath id="unlimitedIcon_svg__clip0_1_1136">
...
export default SvgUnlimitedIcon;
